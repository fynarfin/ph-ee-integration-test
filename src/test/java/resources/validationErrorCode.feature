...
Feature: Validation Error Code Test
  ...
  Scenario: ECV-002 GSMA Transfer Api MandatoryValueNotSupplied Test
  ...
  Scenario: ECV-003 GSMA Transfer Api SamePartiesError Test
  ...
  Scenario: ECV-004 GSMA Transfer Api FormatError Test
